...
| 03-01.T2 | 03-01 | 1 | LAYOUT-03 (ru), LAYOUT-02 (ru) | 03-01/T2 | Свой layout set russian без пятого ряда, moreKeys-паритет 5/4/1; shared east_slavic нетронут | build + aapt2 + git test | `./gradlew assembleDebug && aapt2 dump resources app-debug.apk \| grep russian && [ -z "$(git diff --name-only b0b4606..HEAD -- 'app/src/main/res/xml/*east_slavic*')" ]` | ✅ | ⬜ pending |
