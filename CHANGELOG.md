...
Подробности — `docs/IMPERATIVE-HEADS.md`, артефакт — `docs/APK-AUDIT-1.9.4.md`.
...
Подробности — `docs/SUGGEST-DIES.md`, артефакт — `docs/APK-AUDIT-1.9.3.md`.
...
Подробности — `docs/PREFIX3-BUG.md`, артефакт — `docs/APK-AUDIT-1.9.2.md`.
...
- Вместе с живыми словами вошли обрывки распознавания длиннее трёх букв: `еякх` (9 222-е место), `гдеяэ`, `лпояы`. По выборке в сорок слов — примерно каждое восьмое из вошедших расширением сомнительно. Полный разбор — `docs/DICT-WIDEN.md`
