...
- Русский охват отложенной разговорной выборки — с 91,7499 % до @@RU_COV@@ %: **@@RU_GAIN@@ п.п.**
- Татарский — с 91,6802 % до 92,1402 %: **+0,46 п.п.** Меньше, и причина не в правиле: разговорного татарского в открытом доступе почти нет
- Предсказание следующего слова не изменилось: таблицы биграмм не трогались ни одним байтом

### Размер

- Русский словарь: 606 315 → 618 609 Б (**+12 294**). Татарский: 600 606 → 600 587 Б (**−19**)
...
- Раскладки, наборы эмодзи и таблицы опечаток не изменились
