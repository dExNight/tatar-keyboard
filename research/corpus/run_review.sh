...
python3 make_review.py tat ../../docs/archive/dictionary/DICTIONARY-TT-CONV-REVIEW.tsv $TT
echo "rus начато $(date +%T)"
python3 make_review.py rus ../../docs/archive/dictionary/DICTIONARY-RU-CONV-REVIEW.tsv $RU
