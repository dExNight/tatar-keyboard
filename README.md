...
**Ничего не уходит с устройства.** В манифесте приложения нет разрешения INTERNET — само приложение ничего никуда не отправляет, всё, что вы печатаете, обрабатывается только на устройстве. Это не обещание, а проверяемое свойство: CI проверяет манифест и собранный APK на каждом коммите. Тем же гейтом проверяется, что данные приложения исключены из резервного копирования и переноса на новое устройство (`allowBackup=false`); как следствие, настройки клавиатуры на новом устройстве нужно задать заново. Нет аналитики, нет рекламных SDK, нет Firebase. Единственное, что клавиатура сохраняет локально, — до 24 недавно использованных эмодзи (во внутренней папке, расшифровываемой только после разблокировки устройства, вне облачной резервной копии); подробности и как их стереть — в [PRIVACY.md](PRIVACY.md).
