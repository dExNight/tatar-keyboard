...
- **Татарские подсказки (опционально)**: полоса из трёх частотных продолжений слова, полностью офлайн; по умолчанию выключены, не показываются в полях пароля и других приватных полях, автозамены нет
